import { BellRing, Boxes, CalendarClock, Calculator, Settings2, Target, WalletCards, Banknote, FileText } from 'lucide-react';
import { Link } from 'react-router-dom';

const items = [
  { to:'/reports', icon:FileText, title:'Reports', text:'Monthly, financial-year, budget, cash-flow and savings reports.' },
